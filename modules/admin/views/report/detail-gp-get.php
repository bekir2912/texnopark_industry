            ...
            <div class="col-sm-9">
                ...
                <div class="box">
                    <div class="box-header">
                        Отчетность о принятой продукции в ГП
                        <div class="pull-right">
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-gp-get', 'type'=>'week']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'week') ? 'danger' : 'primary';?>">Неделя</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-gp-get', 'type'=>'month']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'month') ? 'danger' : 'primary';?>">Месяц</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-gp-get', 'type'=>'tmonth']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'tmonth') ? 'danger' : 'primary';?>">3 месяца</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-gp-get', 'type'=>'hyear']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'hyear') ? 'danger' : 'primary';?>">Пол года</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-gp-get', 'type'=>'year']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'year') ? 'danger' : 'primary';?>">Год</a>
                        </div>
                    </div>
