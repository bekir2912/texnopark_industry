...
$this->title = 'Отчетность по отделу штамповка';
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-sm-12"><h3 style="margin-bottom: 20px">Отчет по выпуску кол-ва продукции с <?=$month .' по '. $tomorrow_date?></h3>
