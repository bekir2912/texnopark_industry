            ...
            <div class="col-sm-9"> -->
                            ...
                            <div class="col-sm-3">
                                <div class="box box-warning color-palette-box">
                                    ...
                                    <div class="box-footer">
                                        <a href="<?=Yii::$app->urlManager->createUrl(['/admin/stock/stack-view', 'id'=>$id, 'stack_id'=>$stack->id]);?>" class="btn btn-info" style="width:100%">Посмотреть</a>
                                    </div>
                                </div>
                            </div>
                        <?php }?>
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="box-title">
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/stock/stack-create', 'id'=>$id])?>" class="btn btn-primary">
                            ...
                            <?= GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'label'=>'<i class="fa fa-sort"></i> Кол-во ячеек',
                                        'encodeLabel' => false,
                                            ...
                                            'view' => function ($url, $model) {
                                                return '<div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu pull-left">
                                                            <li><a href="'.Yii::$app->urlManager->createUrl(['/admin/stock/stack-view', 'id'=>$model->stock_id, 'stack_id'=>$model->id]).'" class="dropdown-item">Посмотреть</a></li>
                                                            <li><a href="'.Yii::$app->urlManager->createUrl(['/admin/stock/stack-create', 'id'=>$model->stock_id, 'stack_id'=>$model->id]).'" class="dropdown-item">Редактировать</a></li>
                                                            <li><a href="'.Yii::$app->urlManager->createUrl(['/admin/stock/stack-remove', 'id'=>$model->stock_id, 'stack_id'=>$model->id]).'" class="dropdown-item" class="remove-object">Удалить</a></li>
                                                        </ul>';
                                            }
                                        ],
                                    ]
