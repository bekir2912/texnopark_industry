...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php }?>
        <div class="row box-info color-palette-box">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                ...
                <div class="box box-info color-palette-box">
                    <div class="box-header">
                        Отчетность об отданных деталях в магазин
                        <div class="pull-right">
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-shop', 'type'=>'week']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'week') ? 'danger' : 'primary';?>">Неделя</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-shop', 'type'=>'month']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'month') ? 'danger' : 'primary';?>">Месяц</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-shop', 'type'=>'tmonth']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'tmonth') ? 'danger' : 'primary';?>">3 месяца</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-shop', 'type'=>'hyear']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'hyear') ? 'danger' : 'primary';?>">Пол года</a>
                            <a href="<?=Yii::$app->urlManager->createUrl(['/admin/report/detail-shop', 'type'=>'year']);?>" class="btn btn-<?=(Yii::$app->request->get('type') == 'year') ? 'danger' : 'primary';?>">Год</a>
                        </div>
                    </div>
