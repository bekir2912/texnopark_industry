...
$this->title = "Сборка газового регулятора: " . $page." операцию  " . $model->id;
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            <?= $form->field($model, 'status')->dropDownList([ 0 => "В ожидании", 1 => "Готов", 3 => "На скаладе"]); ?>
                        </div>
                    </div>
                ...
                <?=$form->field($model, 'department_id')->hiddenInput(['value'=>  9])->label(false);?>
