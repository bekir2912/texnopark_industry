        ...
        <?php if ($model) {?>
            <div class="box box-info color-palette-box">
                <div class="box-header">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/waybill', 'id'=>$model->noticeTruck->noticeWaybill->id]);?>" class="btn btn-primary">Накладная</a>
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/truck', 'id'=>$model->noticeTruck->id]);?>" class="btn btn-primary">Прием грузовика</a>
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/control', 'id'=>$model->id]);?>" class="btn btn-success">Контроль качества</a>
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/act', 'id'=>$model->noticeAct->id]);?>" class="btn btn-primary">Акт приемки</a>
                </div>
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><?=$model->noticeControlProducts ? count($model->noticeControlProducts) : '0';?></td>
                        </tr>
                        <tr>
                            <td>Статус:</td>
                            <td>
            ...
            <div class="box box-info color-palette-box">
                ...
                <div class="box-body">
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            //             return '<a href="'.Yii::$app->urlManager->createUrl(['/admin/notice/control-accept-product', 'id'=>$model->id]).'" class="btn btn-success"><i class="fa fa-check"></i></a></li>
                            //                     <a href="'.Yii::$app->urlManager->createUrl(['/admin/notice/control-decline-product', 'id'=>$model->id]).'" class="btn btn-danger"><i class="fa fa-remove"></i></a></li>';
                            //         }
                            //     ],
                            // ]
                        ],
                ...
                <?php if ($model->status == 0) {?>
                    <div class="box-footer">
                        <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/control-accept', 'id'=>$model->id]);?>" class="btn btn-success">Подтвердить</a>
                    </div>
                <?php }?>
            </div>
        <?php } else {?>
