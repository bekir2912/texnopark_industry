...
/**
 * DepartmentPaitingSearch represents the model behind the search form of `app\models\industry\DepartmentPaiting`.
 */
class DepartmentPaitingSearch extends DepartmentPaiting
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'model_id', 'department_id', 'user_id', 'is_ckeck', 'amount', 'part_model', 'is_defect', 'status', 'created_at', 'updated_at'], 'integer'],
