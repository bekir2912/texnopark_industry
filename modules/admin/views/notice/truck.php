        ...
        <?php if ($model) {?>
            <div class="box box-info color-palette-box">
                <div class="box-header">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/waybill', 'id'=>$model->noticeWaybill->id]);?>" class="btn btn-primary">Накладная</a>
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/truck', 'id'=>$model->id]);?>" class="btn btn-success">Прием грузовика</a>
                    ...
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/act', 'id'=>$model->noticeControl->noticeAct->id]);?>" class="btn btn-primary">Акт приемки</a>
                </div>
                <div class="box-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><?=$model->noticeTruckProducts ? count($model->noticeTruckProducts) : '0';?></td>
                        </tr>
                        <tr>
                            <td>Статус:</td>
                            <td>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'label'=>'<i class="fa fa-sort"></i>  Кол-во по факту',
                                'encodeLabel' => false,
                                'value' => function ($model, $key, $index, $column) {
                                    return $model->amount_fact ? $model->amount_fact : $model->amount;
                                },
                            ],
                            [
                                'attribute'=>'description_fact',
                                'label'=>'<i class="fa fa-sort"></i> Объяснение',
                                'encodeLabel' => false,
                                'value' => function ($model, $key, $index, $column) {
                                    return $model->description_fact ? $model->description_fact : '-';
                                },
                            ],
                            // [
