...
/**
 * DepartmentCheckingSearch represents the model behind the search form of `app\models\industry\DepartmentChecking`.
 */
class DepartmentCheckingSearch extends DepartmentChecking
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'department_id', 'model_id', 'part_model', 'is_ckeck', 'user_id', 'is_defect', 'amount', 'status', 'created_at', 'updated_at'], 'integer'],
