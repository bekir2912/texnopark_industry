...
$this->title = "Отливка пластиковых деталий: " . $page." операцию  " . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Plastic', 'url' => ['index']];
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            <?= $form->field($model, 'status')->dropDownList([ 0 => "В ожидании" ,1 => "Готов", 2 => "Проверка", 3 => "На складе"]); ?>
                        </div>
                    </div>
                ...
                <?=$form->field($model, 'department_id')->hiddenInput(['value'=>  8])->label(false);?>
