...
/**
 * DepartmentFormingSearch represents the model behind the search form of `app\models\industry\DepartmentForming`.
 */
class DepartmentFormingSearch extends DepartmentForming
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'department_id', 'model_id', 'is_ckeck', 'part_model', 'user_id', 'is_defect', 'amount', 'status', 'created_at', 'updated_at'], 'integer'],
