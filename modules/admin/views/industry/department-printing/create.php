...
<div class="content-wrapper">
    <section class="content-header">
        <h1><?= "Печать надписей: ".$this->title;?></h1>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            <?= $form->field($model, 'status')->dropDownList(["0" => "В ожидании", "1" => "Закрыт"]); ?>
                        </div>
                    </div>
                ...
                <?=$form->field($model, 'department_id')->hiddenInput(['value'=>  10])->label(false);?>
