...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('model_saved')) {?>
            <div class="alert alert-success text-center">
                <?=Yii::$app->session->getFlash('model_saved');?>
            </div>
        <?php }?>
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="box-header">
                        <div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu pull-left">
                                <li><a href="<?=Yii::$app->urlManager->createUrl(['/admin/industry/product-model/create']);?>" class="dropdown-item">Добавить модель</a></li>
                                <li><a href="<?=Yii::$app->urlManager->createUrl(['/admin/industry/product-model/create', 'id'=>$model->id]);?>" class="dropdown-item">Редактировать</a></li>
                                <li><a href="<?=Yii::$app->urlManager->createUrl(['/admin/industry/product-model/remove', 'id'=>$model->id]);?>" class="dropdown-item" class="remove-object">Удалить</a></li>
                            </ul>
                        </div>
                        <div class="box-body">
