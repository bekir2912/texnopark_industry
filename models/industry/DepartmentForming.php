...
/**
 * This is the model class for table "b_department_forming".
 *
 * @property int $id
 ...
 */
class DepartmentForming extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['department_id', 'model_id', 'part_model', 'user_id', 'is_ckeck', 'is_defect', 'amount', 'status', 'created_at', 'updated_at'], 'integer'],
