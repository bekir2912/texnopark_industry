...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('shop_stack_removed')) {?>
            <div class="alert alert-success text-center">
                <?=Yii::$app->session->getFlash('shop_stack_removed');?>
            </div>
        <?php }?>
        <div class="row">
            <div class="col-sm-3">
                                ...
                                <div class="box box-warning color-palette-box">
                                    ...
                                    <div class="box-body text-center">
                                        <div class="sparkline" data-type="pie" data-offset="90" data-width="150px" data-height="150px">
                                            <?php if ($stack->shopStackShelvings) {?>
                                                <?php foreach ($stack->shopStackShelvings as $shelf) {?>
                                                    <?php $total = 0;?>
                                        ...
                                        <table class="table" style="margin-top:15px">
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-success"><?=count($stack->shopStackShelvings);?></span></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="box-footer">
                                        <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shop/stack-view', 'id'=>$id, 'stack_id'=>$stack->id]);?>" class="btn btn-info" style="width:100%">Посмотреть</a>
                                    </div>
                                </div>
                            </div>
                        <?php }?>
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-title">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shop/stack-create', 'id'=>$id])?>" class="btn btn-primary">
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model, $key, $index, $column) {
                                    return $model->shopStackShelvings ? count($model->shopStackShelvings) : '-';
                                },
                            ],
                            [
                                'attribute'=>'status',
                                    ...
                                    'view' => function ($url, $model) {
                                        return '<div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                <ul class="dropdown-menu pull-left">
                                                    <li><a href="'.Yii::$app->urlManager->createUrl(['/admin/shop/stack-view', 'stack_id'=>$model->id]).'" class="dropdown-item">Посмотреть</a></li>
