                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeControl->noticeTruck->notice_number ? $model->noticeControl->noticeTruck->notice_number : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeControl->noticeTruck->noticeWaybill ? $model->noticeControl->noticeTruck->noticeWaybill->truck_number : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeControl->noticeTruck->noticeWaybill ? $model->noticeControl->noticeTruck->noticeWaybill->truck_number_reg : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeControl->noticeTruck->noticeWaybill ? $model->noticeControl->noticeTruck->noticeWaybill->invoice_number : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeControl->noticeTruck->noticeWaybill->provider ? $model->noticeControl->noticeTruck->noticeWaybill->provider->name_ru : '-';
                            },
                        ],
                        [
                            'attribute'=>'status',
                                ...
                                'view' => function ($url, $model) {
                                    return '<div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-left">
                                                <li><a href="'.Yii::$app->urlManager->createUrl(['/worker/notice/act-view', 'id'=>$model->id]).'" class="dropdown-item">Посмотреть</a></li>
                                            </ul>';
                                }
                            ],
                        ]
