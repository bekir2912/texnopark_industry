...
$page = Yii::$app->request->get('id') ? 'Редактировать' : 'Создать'; 

$this->title = $page.' профиль';
...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('profile_created')) {?>
            <div class="alert alert-success text-center alert-bottom"><?=Yii::$app->session->getFlash('profile_created');?></div>
        <?php }?>
