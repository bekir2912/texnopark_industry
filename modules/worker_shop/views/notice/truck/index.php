                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                return $model->notice_number ? $model->notice_number : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeWaybill ? $model->noticeWaybill->truck_number : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeWaybill ? $model->noticeWaybill->truck_number_reg : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeWaybill ? $model->noticeWaybill->invoice_number : '-';
                            },
                        ],
                        [
                            ...
                            'encodeLabel' => false,
                            'value' => function ($model, $key, $index, $column) {
                                return $model->noticeWaybill->provider ? $model->noticeWaybill->provider->name_ru : '-';
                            },
                        ],
                        [
                            'attribute'=>'status',
                                ...
                                'view' => function ($url, $model) {
                                    return '<div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-left">
                                                <li><a href="'.Yii::$app->urlManager->createUrl(['/worker/notice/truck-view', 'id'=>$model->id]).'" class="dropdown-item">Посмотреть</a></li>
                                            </ul>';
                                }
                            ],
                        ]
